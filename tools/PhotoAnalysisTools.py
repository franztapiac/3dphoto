...
def AlignPatientToTemplate(surface, landmarks, select_landmarks=None):
    ...
    if type(select_landmarks) == list:
        selected_templateLandmarks_forRegisitration = SelectLandmarks(templateLandmarks_forRegisitration,
                                                                      landmarks_we_want)
    ...
    template_space_mesh = CreateContinuousModelOfExternalCranialSurface(template_space_mesh, template_space_landmarks,
